...
package net.mcreator.samp.world.biome;
...
import net.mcreator.samp.SampModElements;

@SampModElements.ModElement.Tag
public class SasaBiome extends SampModElements.ModElement {
	public static Biome biome;
	public SasaBiome(SampModElements instance) {
		super(instance, 1);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.OAK_WOOD.getDefaultState(),
								Blocks.OAK_WOOD.getDefaultState(), Blocks.OAK_WOOD.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("samp:sasa"));
			}
		}
	}
	@Override
